...
{College Intern Technical - Medium Range Tactical Systems (MRTS) Control Segment}
{
	...
	$\cdot$ Created a Tomcat based Java servlet to receive JSON messages through a REST service to parse and translate to a standard message type output to control various services
